...
import Registercattle from './Registercattle'
                  ...
                  <View style={styles.profilebreedcontainer}>
                    ...
                    <View style={{flexDirection:'column'}}>
                        <View style={{flexDirection:'row', justifyContent: 'space-between', fontSize:18, }}>
                           ...
                           <Text style={styles.editbreedinfobtn}> Edit</Text>
                        </View>
                         <View>
                         ...
                         <View >
                           ...
                           <View style={{flexDirection:'row', justifyContent: 'space-between', fontSize:18, }}>
                             ...
                             <Text style={styles.editprevpregnfobtn}> Edit</Text>
                           </View>
...
export default class BreedInformation4 extends Component<Props> {
